...
router.get("/:userid", jwtValidation, authMiddleware(["admin", "client", "premium"]), usersControllers.findById);
router.post("/",jwtValidation, authMiddleware(["admin"]), usersControllers.createUser);
router.delete("/:username", jwtValidation, authMiddleware(["admin"]), usersControllers.deleteUser);
